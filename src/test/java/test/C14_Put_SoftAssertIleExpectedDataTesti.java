...
public class C14_Put_SoftAssertIleExpectedDataTesti {
    ...
    @Test
    public void put01(){
        // 1 - Request URL ve Body hazirla (PUT method'u icin Body gereklidir)
        ...
        expData.put("data",reqBody); // yukarida olusturdugumuz regBody'i buraya yerlestirdik
        expData.put("message","Successfully! Record has been updated.");

        // 3 - Response'u kaydet

        Response response= given().
                                    contentType(ContentType.JSON).  // eger Body gondereceksek contentType(ContentType.JSON) koyuyoruz
                            when().
