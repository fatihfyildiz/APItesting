...
public class C16_BaseUrlHerokuapp extends HerokuAppBaseURL {
    ...
    */
    ...
    1-  https://restful-booker.herokuapp.com/booking endpointine bir GET
        ...
        ve Response'ta 24389 numarali boookingID'sine sahip bir booking oldugunu test edin
    */

        // 1- Url hazirlayalim (GET oldugu icin Body'e gerek yok)
        ...
        // 4 - Assertion
        response.then().assertThat().statusCode(200).body("bookingid", Matchers.hasSize(24389));
    ...
    */
        ...
        /*
        yukarida sadece firstname yazinca olmuyor, erismek icin booking.firstname yazmaliyiz " " icine...
         */
